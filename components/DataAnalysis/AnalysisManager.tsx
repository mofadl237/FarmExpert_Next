...
interface IProps{
    ...
    pieDataStaff:{ name: string; value ?: number }[];

}
const AnalysisManager = ({FarmId,role,email,chartDataMilk,MilkLitre,PieDataCattle,pieDataStaff}:IProps) => {
  return (
    <div className="w-full   ">
            ...
            <div className="flex flex-col md:flex-row justify-between w-full gap-4 mb-4">
                ...
                <PieChartCard key={'staff'} COLORS={["#ef4444", "#a855f7", "#0ea5e9"]} title="Staff" data={pieDataStaff ?? []} />
            </div>
