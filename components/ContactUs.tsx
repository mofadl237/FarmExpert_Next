...
const ContactUs = () => {
  ...
  return (
    <div className="bg-gradient-to-tr from-[#68CD75] to-[#2DB683] w-full h-screen flex justify-center items-center">
          <div className={`relative  w-[80%]  h-[90%] bg-[url('/main-2.jpg')]  rounded-[4px] shadow-md bg-top`}>
            <div
              className={`absolute    h-full w-full md:w-[60%] bg-[rgba(255,255,255,0.9)]  rounded-[4px] z-10 ${isArabic && 'end-0'} `}
